...
<body>
<div class="container">
    <table id="dg" class="easyui-datagrid" style="width:100%;height:554px" url="/second/tab/list" title="二级标签管理"
           data-options="
                rownumbers:true,
                singleSelect:false,
                autoRowHeight:false,
        ...
        <thead>
        <tr>
            <th field="ancestryTab" width="200">导航</th>
            <th field="parentTab" width="200">一级标签</th>
    ...
    <div id="tb" style="padding:0 30px;">
        ...
        <input id="search" class="easyui-textbox" type="text" name="code"
               style="width:166px;height:35px;line-height:35px;"/>
        <label for="parentIdDh">导航：</label>
        <input id="parentIdDh" class="easyui-combobox"
               name="parentIdDh"
               data-options="
					url:'/channel/list',
					method:'get',
...
<script type="text/javascript">
    ...
    //数据分页
    $(function () {
        $('#dg').datagrid({url: "/second/tab/list"}).datagrid('clientPaging');
    ...
    function submitForm() {
        if ($('#editChannelName').val().length < 2) {
            ...
            $.messager.alert('提示', '请选择您标签的上级', 'error')
        } else {
            $('#ff').form('submit', {
                url: "/update/tab",
                onSubmit: function () {
...
<div id="edit" class="easyui-dialog" title="标签编辑" data-options="closed:true"
     style="width:440px;height:300px;padding:10px;">
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" method="post">
            <table cellpadding="5">
                <tr>
                    <td>二级标签名称:</td>
                    <td><input type="text" id="editChannelName" name="editChannelName" style="height:35px;"><br/><input
                            style="display: none" name="editId" id="editId"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
