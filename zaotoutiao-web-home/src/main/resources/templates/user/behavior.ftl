        ...
        <div style="padding:10px 60px 20px 60px">
            <form id="ff" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="easyui-combobox" name="channelId" id="channelId" style="height:35px;" data-options="onLoadSuccess:function(data){
                              ...
                              },required:true,editable:false,onSelect:function(params){showBehaviorMapper();}"/>
                        </td>
                    </tr>
                    <tr>
                        <td>指标</td>
                        <td>
                            <select class="easyui-combobox" name="index" id="index" style="height:35px;" data-options="">
                ...
                <div class="easyui-panel" style="padding:5px;">
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1',selected:true" onclick="getListBehavior('today')">今天</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('yesterday')">昨天</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('sevenDays')">最近7天</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('thirtyDays')">最近30天</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('days')">按日</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('weeks')">按周</a>
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getListBehavior('months')">按月</a>
                    ...
                    <a href="#" class="easyui-linkbutton" data-options="toggle:true,group:'g1'" onclick="getData('hours')">查询</a>
                </div>
            ...
            <table id="dg" style="width:100%;height:100px" title="用户行为统计列表" data-options="
                ...
                <tr>
                    <td>${countDownLoadNum}</td>
                    <td>${countActivationRateNum}</td>
                    <td>${countActivationNum}</td>
                    <td>${countRegisterRateNum}</td>
                    <td>${countRegisterNum}</td>
                    <td>${countOperationNum}</td>
                </tr>
                <tbody>
                </tbody>
            </table>
            ...
            <div class="chart0-item">
                <div class="item-inner">
                    <div class="item-content">
                        ...
                        <table id="beh_info" style="width:100%;height:554px" title="全体供应商列表" data-options="
                autoRowHeight:false,
                fitColumns:true">
                        </table>
                    </div>
